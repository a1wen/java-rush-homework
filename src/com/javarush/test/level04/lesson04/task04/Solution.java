...
public class Solution
{
    ...
    public static void checkSeason(int mount){
        //::CODE:
        if(mount>12) System.out.println("такого месяца не существует");
        else if (mount == 12||mount==1||mount==2) System.out.println("зима");
        else if(mount>2&mount<=5) System.out.println("весна");
        else if (mount>5&mount<=8) System.out.println("лето");
